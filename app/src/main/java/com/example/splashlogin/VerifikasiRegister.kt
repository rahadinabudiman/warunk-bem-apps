...
class VerifikasiRegister : AppCompatActivity() {
    ...
    private fun VerifyLoginUser(verifyLogin: VerifyLogin) {
        ...
        val request = Request.Builder()
            .url("http://10.0.2.2:8080/api/v1/user/activation/")
            .post(requestBody)
            .build()
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: okhttp3.Response) {
                ...
                if (response.isSuccessful) {
                    ...
                    if (baseResponse != null) {
                        if (baseResponse.status_code == 200) {
                            ...
                            if (VerifikasiResponse != null) {
                                ...
                                val intent = Intent(this@VerifikasiRegister, Login::class.java)
                    ...
                    runOnUiThread {
                        Toast.makeText(this@VerifikasiRegister, "Verifikasi gagal", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        })
